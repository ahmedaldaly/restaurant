  ...
  return (
    ...
    <AnimatePresence>
      <motion.header
        ...
        className={` ${
          menu
            ? "h-64 flex-wrap w-full flex z-50 justify-between backdrop-blur-xl items-start pt-5 px-5"
            : "w-full h-18 flex justify-evenly z-50 items-center bg-white/70 backdrop-blur-xl dark:text-white dark:bg-[#020817]"
        }  ${
          scroll &&
